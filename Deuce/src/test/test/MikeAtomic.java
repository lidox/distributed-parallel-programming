...
public class MikeAtomic {
	...
	public static void main (String[] args) {
		...
		System.out.println("#commits="+org.deuce.transaction.lsa.Context.counter_EOT);
		System.out.println("#aborts="+org.deuce.transaction.lsa.Context.counter_Abort);
	}
